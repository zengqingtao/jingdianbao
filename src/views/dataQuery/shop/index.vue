  ...
  <div class="container">
    ...
    <div class="modul instant-query">
      <div class="query-options">
        <el-form class="form" ref="form" :rules="formRules" :model="form" label-width="90px" @submit.native.prevent>
      ...
      <div class="query-results" v-if="allData">
        ...
        <div class="data-area" v-if="!isArea">
          <div class="chart">
            ...
            <div v-if="!currentChooseNullData">
              <div class="category">店铺名称：{{description}}</div>
        ...
        <!-- 表格 -->
        <div>
          <div class="table-category" v-if="form.queryPort=='4'">店铺名称：{{description}}</div>
