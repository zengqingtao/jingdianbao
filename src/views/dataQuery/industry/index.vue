  ...
  <div class="container">
    ...
    <div class="modul instant-query">
      ...
      <div class="query-results" v-if="allData">
        ...
        <div class="data-area" v-if="!isArea">
          <div class="chart">
            ...
            <div v-if="!currentChooseNullData">
              <div class="category">三级类目：{{description}}</div>
        ...
        <!-- 表格 -->
        <div>
          <div class="table-category" v-if="form.queryPort=='4'">三级类目：{{description}}</div>
